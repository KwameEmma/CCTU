...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center" style = "background-color: blue;">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a href="index.php" class="active" style="color: #FB4E7C;">Home</a></li>
          <li><a href="#" style="color: #FB4E7C;">Portal</a></li>
          <li><a href="blog.php" style="color: #FB4E7C;">News</a></li>
          <li><a href="about.html" style="color: #FB4E7C;">About</a></li>
        </ul>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row content">
          <div class="col-lg-6">
            <h2>TESCON (Tertiary Students Confederacy)</h2>
            <h5>TESCON (Tertiary Students Confederacy) is the student wing of the New Patriotic Party(NPP) of Ghana founded on
              8 January 2000. It was inaugurated by the 2nd President of the 4th Republic of Ghana, John Agyekum Kufuor.
              Since its formation, TESCON has been one of the most important wing of the NPPs student and political activism
              and grass-root mobilisation</h5>
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <p>
              Aims of TESCON (Tertiary Students Confederacy)

            </p>
            <ul>
              <li><i class="ri-check-double-line"></i> To offer a common forum for the discussion of problems affecting students
                especially(Tesconians) and generally to develop a spirit of solidarity among students.</li>
              <li><i class="ri-check-double-line"></i> To promote cooperation understanding and friendship among other institutions.</li>
              <li><i class="ri-check-double-line"></i> To work in close harmony with other organisations who share in the ideas of the
                 New Patriotic Party.</li>
              <li><i class="ri-check-double-line"></i> To advocate for rule of law in the country with particular reference to issues
                militating against the economy,social, governance and general public.</li>
            </ul>
            <p class="fst-italic">
              To call for and at all times seek DEVELOPMENT IN FREEDOM.
            </p>
          </div>
        </div>
    ...
    <section id="team" class="team section-bg">
        ...
        <div class="row">
          ...
          <div class="col-lg-5" style="margin: 5px;">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="Admin/userimage/<?= $image?>" class="img-fluid" alt=""></div>
      ...
      echo '<nav aria-label="Page navigation" style="margin-top: 8px; position: relative; left: 45%;"';
